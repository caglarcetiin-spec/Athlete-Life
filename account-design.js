...
const pages={
 ...
 training:{title:'Hareket ve set kaydı',text:'Yeni dönemlerini Plan bölümünde oluştur. Burada hareket kayıtlarına ve önceki kuvvet programının uygulama araçlarına eriş.',keep:['#manualTrainingDate','#exerciseSelect','#exerciseLog'],titles:[]},
 ...
 coach:{title:'Kuvvet programı incelemesi',text:'Önceki hareket programının gerekçeleri ve yol haritası. Çok branşlı dönemin ana kaynağı Plan bölümüdür.',keep:['#coachDecision'],titles:['Koç Kararı']},
 character:{title:'Profilin ve ölçümlerin',text:'Branşlarını, hedeflerini ve zamanını düzenle. Fiziksel testleri ihtiyaç duyduğunda aç.',keep:['#sports-profile-card'],titles:[]},
...
function tools(){
 ...
 const links=[['today','Günlük durum ve sağlık','Bugün'],['week','Vardiya takvimi','Plan'],['training','Hareket ve set kaydı','Antrenman'],['nutrition','Besin ve su günlüğü','Beslenme'],['analytics','Grafikler ve dönem eğilimleri','Gelişim'],['detailed','Vücut ölçümleri ve fotoğraflar','Gelişim'],['character','Profil ve fiziksel testler','Gelişim'],['reports','3D vücut ve toparlanma','Gelişim'],['records','Kayıtları düzelt','Veriler'],['coach','Önceki kuvvet programını incele','Plan'],['settings','Hedefler, yedek ve ayarlar','Veriler']];
