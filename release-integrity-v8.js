...
function run(){
 ...
 try{const n=window.AdaptiveNutrition?.targets?.();t("Adaptive nutrition finite",(window.ALOSAccount&&n===null)||[n?.kcal,n?.proteinG,n?.carbsG,n?.fatG].every(Number.isFinite),JSON.stringify(n))}catch(e){t("Adaptive nutrition finite",false,e.message)}
